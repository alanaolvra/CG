...
def carregar_barraca():
    global barraca_modelo, texturas_carregadas, barraca_display_list
    try:
        ...
        # Gera display list
        barraca_display_list = glGenLists(1)
        glNewList(barraca_display_list, GL_COMPILE)
...
def desenhar_barraca(ladox, ladoz):
    global barraca_modelo, barraca_display_list
    ...
    if barraca_display_list:
        glCallList(barraca_display_list)
