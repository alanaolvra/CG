...
artesanato_modelo = None
artesanato_display_list = None
texturas_carregadas = {}

def carregar_artesanato():
    global artesanato_modelo, texturas_carregadas, artesanato_display_list
    try:
        artesanato_modelo = pywavefront.Wavefront(
            'script/feira.obj',
        ...
        # Carrega texturas
        for nome_material, material in artesanato_modelo.materials.items():
        ...
        # Gera display list
        artesanato_display_list = glGenLists(1)
        glNewList(artesanato_display_list, GL_COMPILE)
        for mesh in artesanato_modelo.mesh_list:
        ...
        print("[✓] Modelo artesanato carregado e cacheado com sucesso")

    except Exception as e:
        print(f"[Erro] Falha ao carregar modelo artesanato: {e}")
...
def desenhar_artesanato(ladox, ladoz):
    global artesanato_modelo, artesanato_display_list

    if artesanato_modelo is None:
        carregar_artesanato()
        bbox_artesanato = calcular_bounding_box(artesanato_modelo)
        bbox_artesanato = transformar_bounding_box(bbox_artesanato, [1.3, 1, 2.4], [-10, 0, -10])
        objetos_colisao["artesanato"] = bbox_artesanato
    ...
    if artesanato_display_list:
        glCallList(artesanato_display_list)
